...
export default function LoginPage() {
  ...
  async function handleSubmit(e) {
    ...
    if (result.ok) navigate('/workspace');
    ...
    <AuthLayout>
      ...
      >
        <div className="mb-8">
          ...
          <p className="mt-2 text-base text-text-muted">Your memories are waiting.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-4">
          ...
          <div className="flex justify-end">
            <button type="button" className="text-xs font-medium text-text-muted transition-colors hover:text-heading">
              Forgot password?
            </button>
          </div>
        ...
        <p className="mt-6 text-center text-sm text-text-muted">
          ...
          <Link to="/auth/signup" className="font-semibold text-heading underline-offset-2 hover:underline">
            Sign up
          </Link>
        </p>
      </motion.div>
